...
def initialise_params(time_step, matrix_size):
    ...
    return r, R_phi, p_phi_R_phi, p_phi_R_phi_global, p_r_R_r, phi_global_time, phi_step, dphi_r, alpha_AVP, c_AVP, alpha_d_phi_f_phi_FHN,
    c_d_phi_f_phi_FHN, b_d_phi_f_phi_FHN, alpha_fun_phi_AVP, alpha_fun_phi_FHN, gamma_AVP, b_AVP, mu1, mu2, a_r_FHN, b_r_FHN, tol, R_r_step,
    nint, nsqint, ncubint, nquadint, ngradint, nfluxint
